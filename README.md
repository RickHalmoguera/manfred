...
# Ricardo Halmoguera Garcia's CV

This repository contains **my professional data**, stored as a [MAC](/CV/MAC.json) (or Manfred Awesomic CV), an open-source, interchangeable, machine-readable format. It's also synchronized with [my profile in Manfred](https://getmanfred.com/profile/c8386cbf-db3b-499a-a356-65499c6284f6).
<br/>
<br/>

<div align='center'>
  <img src='https://img.shields.io/static/v1?label=CV%20Last%20Sync&message=2024-02-01 10:51 UTC&color=brightgreen&style=for-the-badge'>
